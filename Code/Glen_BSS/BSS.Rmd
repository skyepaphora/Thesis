...
```{r}
X1 <- normalize(Wave(left = nss.1[1,], samp.rate = 8000, bit = 8), unit = "8")
X2 <- normalize(Wave(left = nss.1[2,], samp.rate = 8000, bit = 8), unit = "8")
X3 <- normalize(Wave(left = nss.1[3,], samp.rate = 8000, bit = 8), unit = "8")
X4 <- normalize(Wave(left = nss.1[4,], samp.rate = 8000, bit = 8), unit = "8")
```
